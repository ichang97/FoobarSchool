                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{route('classrooms.index')}}">Classrooms</a>
                                    <a class="dropdown-item" href="{{route('courses.index')}}">Student courses</a>
                                    <a class="dropdown-item" href="{{route('scores.index')}}">Scores Sheet</a>
